...
PN.FX("RNEW",PP,RG,SW)   =  NCAP("RNEW",PP,RG);
...
PN.LO("H2",tp10,RG,SW)$(ORD(tp10) ge 2)   =  1.1*NCAP("H2","2020",RG);
PH.FX(HT,TBASE,RG,SW)          =  HCAP(HT,TBASE,RG);
PH.FX(HT,"2020",RG,SW)         =  HCAP(HT,"2020",RG);
PH.LO("GAS-h2",tp20,RG,"SW1")  =  (1+0.16*ord(tp20))*HCAP("GAS-h2","2020",RG);
...
CLEV.LO(tp30,RG,sw)      =  CARLIM("sw1",tp30,RG);
