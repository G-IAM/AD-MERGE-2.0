...
PE.UP("Nuc-LWR",tp,"peak",RG,SW)         =  0;
PE.UP("Nuc-SFR",tp,"peak",RG,SW)         =  0;
PE.UP("Nuc-VHTR",tp,"peak",RG,SW)         =  0;
PE.FX("Nuc-LWR","2020","nonpeak",RG,SW)    =  ECAP("Nuc-LWR","2020",RG);
...
PN.LO("RNEW",PP,RG,SW)   =  NCAP("RNEW","2020",RG);
...
PN.LO("H2",tp10,RG,SW)$(ORD(tp10) le 1)   =  NCAP("H2",tp10,RG);
PN.LO("H2",tp10,RG,SW)$(ORD(tp10) ge 2)   =  NCAP("H2","2020",RG);
PH.FX(HT,TBASE,RG,SW)       =  HCAP(HT,TBASE,RG);
PH.FX(HT,"2020",RG,SW)       =  HCAP(HT,"2020",RG);
PH.LO("GAS-h2",tp20,RG,"SW1")$(ORD(tp20) le 3)       =  (1-0.3*ord(tp20))*HCAP("GAS-h2","2030",RG);
PH.LO("gas-h2-CCS",tp20,RG,"SW1")$(ORD(tp20) le 3)       =  HCAP("gas-h2-CCS",tp20,RG);
PH.LO("electrolysis",tp20,rg,"SW1")$(ORD(tp20) le 3)     =  HCAP("electrolysis",tp20,rg);
...
* ------------------------------------------------------------------------------*
*  This section of the code corresponds to file ABATE.TAB
* ------------------------------------------------------------------------------*
...
* ------------------------------------------------------------------------------*
*  This section of the code corresponds to file SINKS.TAB
* ------------------------------------------------------------------------------*
...
* ------------------------------------------------------------------------------*
*  This section of the code corresponds to file INITGHG.TAB
* ------------------------------------------------------------------------------*
